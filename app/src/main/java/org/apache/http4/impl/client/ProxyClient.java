...
import org.apache.http4.entity.BufferedHttpEntityHC4;
...
import org.apache.http4.protocol.BasicHttpContextHC4;
...
import org.apache.http4.util.EntityUtilsHC4;
...
public class ProxyClient {
    ...
    public Socket tunnel(
        ...
        if (status > 299) {
            ...
            conn.close();
            throw new org.apache.http4.impl.execchain.TunnelRefusedException("CONNECT refused by proxy: " +
